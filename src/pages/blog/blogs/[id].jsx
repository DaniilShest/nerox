...
const BlogDetails = () => {
    ...
    return (
        <>
            ...
            <Header dynamic={true} />
            <Breadcrumb dynamic={"/" + "assets/img/breadcrumb/breadcrumb-bg-1.jpg"} title="BLOG DETAILS"
                        ...
                        <div className="col-xl-8 col-lg-8">
                            <div className="postbox__wrapper pr-20 mb-60">
                                ...
                                <div className="postbox__meta mt-50">
                                    <span className="postdetails-tag">Finance & Businss</span>
                                    <span><i className="far fa-user"></i>John Smith</span>
